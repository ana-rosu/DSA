...
high_resolution_clock::time_point  start, endd;
duration<double> total_seconds;
...
void countingSort(int arr[], int n){
	long long aux[n], cnt=0, maxi=-1, mini=9999999999;
	if(n<1000000){
	for(int i = 0; i < n; i++){
		fr[arr[i]]++;
...
void testare(int n){
	...
	duration<double> total_seconds = endd - start;
